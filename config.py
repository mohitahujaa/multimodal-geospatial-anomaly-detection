...
# Phase 6: Multimodal Anomaly Detection Directories
ANOMALY_DIR = PROCESSED_DATA_DIR / "anomaly"
ANOMALY_FEATURE_SCORES_DIR = ANOMALY_DIR / "feature_scores"
ANOMALY_EVENTS_DIR = ANOMALY_DIR / "events"
ANOMALY_VALIDATION_DIR = ANOMALY_DIR / "validation"
ANOMALY_PLOTS_DIR = ANOMALY_DIR / "plots"
ANOMALY_REPORTS_DIR = ANOMALY_DIR / "reports"

for d in [ANOMALY_DIR, ANOMALY_FEATURE_SCORES_DIR, ANOMALY_EVENTS_DIR, ANOMALY_VALIDATION_DIR, ANOMALY_PLOTS_DIR, ANOMALY_REPORTS_DIR]:
    d.mkdir(parents=True, exist_ok=True)
